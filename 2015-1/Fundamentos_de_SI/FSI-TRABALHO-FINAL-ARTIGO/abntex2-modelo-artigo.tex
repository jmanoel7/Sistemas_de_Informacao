...
% ---
\titulo{SISTEMAS DE INFORMAÇÃO\\ UMA VISÃO ABRANGENTE}
\autor{João Manoel Leite Ribeiro Nogueira \thanks{joao.manoel@academico.ifg.edu.br}}
\local{Goiânia - Goiás}
\data{2015}
% ---
...
\hypersetup{
		...
		pdftitle={\@title}, 
		pdfauthor={\@author},
    	pdfsubject={Sistemas de Informação},
	    pdfcreator={Vim-LaTeX with abnTeX2},
...
\begin{resumoumacoluna}
 ...
 \noindent
 \textbf{Palavras-chave}: Sistemas de Informação. Regras de Negócios. Ciclo de Vida. Desenvolvimento. 
\end{resumoumacoluna}
