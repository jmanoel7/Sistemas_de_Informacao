-- Popula o Banco de Dados Loja de CDs


-- Popula a Tabela Autor
...
-- Atualiza o valor inicial da sequence a partir do último cadastrado em cada tabela
