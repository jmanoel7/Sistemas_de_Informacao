...
-- Algebra Relacional
-- Seleção Condicional --> WHERE
-- Relações -- > FROM Tabelas
-- Projeção --> Colunas que serão mostradas SELECT

SELECT  nome_autor, nomemusica   -- projeção --
FROM    Autor, Musica            -- Produto Cartesiano -- 
WHERE   nome_autor like 'A%';    -- seleção --